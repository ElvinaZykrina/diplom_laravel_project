...
class Basket
{
    ...
    public function __construct($createOrder = false)
    {
        ...
        // если пользователь авторизован то создаст с ним user_id, если нет - пустой
    ...
    public function saveOrder($name, $phone, $recieve_method, $address, $email)
    {
        ...
        return $this->order->saveOrder($name, $phone, $recieve_method, $address, $email);
